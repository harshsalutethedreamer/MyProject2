 ...
 */
public class NumerosSearchListLoader extends AsyncTaskLoader<List<InformationActivity>> {
    private static final String LOG_TAG=NumerosSearchListLoader.class.getSimpleName();
    private List<InformationActivity> mNumeros;
    private ContentResolver mContentResolver;
    private Cursor mCursor;
    private String mfilterText;

    public NumerosSearchListLoader(Context context, Uri uri, ContentResolver contentResolver, String filterText){
        super(context);
    ...
    public List<InformationActivity> loadInBackground() {
        ...
        String selection = NumeroContract.NumeroColumns.NUMERO_CATEGORY + " LIKE '" + mfilterText + "%'";
